...
public class LoginFragment extends Fragment {
    ...
    public void loginUser() {
        String userUserName = requireActivity().getIntent().getStringExtra("username");
        ...
        if (TextUtils.isEmpty(userEmail)) {
            ...
            boolean checkUserEmailPassword = DB.checkUserEmailPassword(userEmail, pass);
            if (checkUserEmailPassword) {
                Log.d("LoginFragment", "Successful Login");

                //Intent goToHome = new Intent(requireContext(), HomeActivity.class);
                //goToHome.putExtra("username", userUserName);
